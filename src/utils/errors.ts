 ...
 *
 * Custom error classes and error handling helpers for the Asana API.
 */

/**
 * Base Asana API error
 */
 ...
 * Not found error
 */
export class NotFoundError extends AsanaApiError {
 ...
 * Validation error
 */
export class ValidationError extends AsanaApiError {
...
/**
 * Premium feature error (for features requiring paid Asana plan)
 */
export class PremiumRequiredError extends AsanaApiError {
  constructor(feature: string) {
    super(`${feature} requires an Asana Premium or higher plan`, 402, 'PREMIUM_REQUIRED', false);
